...
(slope-middle) and study the irreducible datum $\Pmid=|\Scat_{mm}|^2$. Canonical anchor (used for the
numerical certification, \S\ref{sec:cert}): $\eps=(-2,0,3)$, $\gamma=(1,0.8,1.2)$, $a=(-1,0.5,2)$, for which
$\Pmid=0.214724\ldots$
