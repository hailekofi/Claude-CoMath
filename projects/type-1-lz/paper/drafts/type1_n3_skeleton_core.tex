% ============================================================================
% SHELVED (2026-06-10). NOT to be pushed as a paper. See RESEARCH_LOG.md (R29).
% Reason: the skeleton/core construction -- and wildness, non-rigidity,
% transcendence -- are GENERIC N=3 MLZ structure, reproduced by a random
% symmetric H0 (ws_construction_generic.py); the Cauchy/Type-1 form is not used.
% The factorization is generic LU; the slot equations are a UDL reconstruction
% identity (tautological). Kept for the record only. The genuine surviving
% results (trdeg-2; sigma order-2-not-order-1 DA; the non-rigidity->Painleve
% mechanism) live in the research log; the open Type-1 question (does
% integrability leave any fingerprint?) is recorded there.
% ============================================================================
