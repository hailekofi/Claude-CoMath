...
% experiments/r8_proof.py, paper/r8_accessory_node_proof.md. Evidence: PROVEN (symbolic identity
...
\emph{interior} content --- the middle-slope survival $\Pmid$ and one off-diagonal --- is the genuinely
...
$c{=}1$ confluent isomonodromy problem [companion working paper, this project].
...
Fredholm-determinant / Widom representation of $c{=}1$ connection constants [Cafasso, Gavrylenko \&
...
\begin{equation}
M(v)w=\mu w\ \Longleftrightarrow\ (H_0-vI)w=\mu A w\ \Longleftrightarrow\ H(-\mu)\,w=v\,w .
\label{eq:duality}
\end{equation}
...
\[
\text{commuting partner}\ \Rightarrow\ \text{exact crossing}\ \Rightarrow\ \text{accessory pinned}\
\Rightarrow\ \text{algebraic connection data},
\]
